...
// Electronics
  ...
  { name: 'Portable Charger', category: 'electronics', price: 49.99, originalPrice: 69.99, discount: 29, description: '20000mAh dual USB output', rating: 4.6, images: '/products/electronics-cable.jpg' },
  ...
  { name: 'Denim Jeans', category: 'clothing', price: 69.99, originalPrice: 99.99, discount: 30, description: 'Classic fit, premium denim', rating: 4.5, images: '/products/clothing-tshirt.jpg' },
  ...
  { name: 'Makeup Brush Set', category: 'beauty', price: 34.99, originalPrice: 54.99, discount: 36, description: '12 brushes with case', rating: 4.6, images: '/products/clothing-tshirt.jpg' },
  { name: 'Hair Mask', category: 'beauty', price: 19.99, originalPrice: 34.99, discount: 43, description: '200ml deep conditioning', rating: 4.5, images: '/products/clothing-tshirt.jpg' },
  ...
  // Books
  { name: 'Fiction Novel', category: 'books', price: 16.99, originalPrice: 26.99, discount: 37, description: 'Bestselling literary fiction', rating: 4.5, images: '/products/clothing-tshirt.jpg' },
  { name: 'Science Book', category: 'books', price: 24.99, originalPrice: 39.99, discount: 38, description: 'Quantum physics explained', rating: 4.6, images: '/products/clothing-tshirt.jpg' },
  { name: 'Self-Help Guide', category: 'books', price: 18.99, originalPrice: 29.99, discount: 37, description: 'Personal development tips', rating: 4.4, images: '/products/clothing-tshirt.jpg' },
  { name: 'Cookbook', category: 'books', price: 29.99, originalPrice: 49.99, discount: 40, description: '100 easy recipes, hardcover', rating: 4.7, images: '/products/clothing-tshirt.jpg' },
  { name: 'Travel Guide', category: 'books', price: 22.99, originalPrice: 34.99, discount: 34, description: 'Backpacking essentials', rating: 4.5, images: '/products/clothing-tshirt.jpg' },
  { name: 'History Book', category: 'books', price: 28.99, originalPrice: 44.99, discount: 36, description: 'World history overview', rating: 4.6, images: '/products/clothing-tshirt.jpg' },
  { name: 'Poetry Collection', category: 'books', price: 14.99, originalPrice: 24.99, discount: 40, description: 'Classic poems anthology', rating: 4.5, images: '/products/clothing-tshirt.jpg' },
  { name: 'Comic Book', category: 'books', price: 12.99, originalPrice: 19.99, discount: 35, description: 'Adventure series vol 1', rating: 4.3, images: '/products/clothing-tshirt.jpg' },
]
